...
void UTILS_PrintCounter(int count){ 
	uint8_t Digit1=count / 10000; 
	uint8_t Digit2=count %10000 /1000; 
	uint8_t Digit3=count %1000 /100; 
	uint8_t Digit4=count %100/10;  
	uint8_t Digit5=count %10;  
	UART0_Transmit(Digit1+48);
	UART0_Transmit(Digit2+48);
	UART0_Transmit(Digit3+48);
	UART0_Transmit(Digit4+48);
	UART0_Transmit(Digit5+48);
}